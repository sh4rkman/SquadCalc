...
export const squadVehicleMarker = Marker.extend({
    ...
    _onShow(tip) {
        ...
        if (this.vehicle.ticketValue === 1) oneOrMoreTickets = "ticket";
        ...
        let html = `
            <div class='spawnVehicleCard animate__animated animate__fadeIn animate__faster'>
                ...
                <div class="respawnHolder">
                    ...
                    <span>${this.vehicle.respawnTime} ${i18next.t("common:min")}</span>
                </div>
