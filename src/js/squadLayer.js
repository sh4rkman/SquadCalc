...
export default class SquadLayer {
    ...
    createHelipads() {
        this.layerData.assets.helipads.forEach((asset) => {
            ...
            iconElement.style.backgroundImage = `url('/api/v2/img/icons/ally/deployables/deployable_helipad.webp')`;
    ...
    createDeployables() {
        ...
        this.layerData.assets.deployables.forEach((asset) => {
            ...
            if (asset.type === "Repair Station") {
                ...
                const iconElement = marker.getElement();
                iconElement.style.backgroundImage = `url('/api/v2/img/icons/ally/deployables/deployable_repairstation.webp')`;
                this.mainZones.assets.push(marker);
            }
            ...
            if (asset.type === "Ammo Crate") {
                ...
                const iconElement = marker.getElement();
                iconElement.style.backgroundImage = `url('/api/v2/img/icons/ally/deployables/deployable_ammocrate.webp')`;
                this.mainZones.assets.push(marker);
